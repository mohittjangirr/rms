...
<html lang="en">
    <head>
        ...
        <title>Acedemia | Create Institute </title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Create Student Institute</h2>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Create Student Institute</h5>
                                                </div>
                                            </div>
           <?php if($msg){?>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Institute Name</label>
                                                		<div class="">
                                                			<input type="text" name="classname" class="form-control" required="required" id="success">
                                                            <span class="help-block">Eg- Shree Vinayk Classes</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
